...
function changeURLParam(elem) {
   ...
   document.location.href = `https://ilhamshf.my.id/al-quran/hadits/daftar/?id=${idPerawi}&jumlah=${jumlahHadits}&page=${elem.getAttribute('data-num')}&range=${rangeAwal}-${rangeAkhir}`
}
